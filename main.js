...
(function (canvas) {
    ...
    // destoy action
    // setTimeout(clearTimeout(action), 20);
    ...
    var action3 = setInterval(function () {
        onResize();
        render3();
